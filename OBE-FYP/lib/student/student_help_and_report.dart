...
class StudentHelpAndReport extends StatefulWidget {
  const StudentHelpAndReport({super.key});

  @override
  State<StudentHelpAndReport> createState() => _StudentHelpAndReportState();
}

class _StudentHelpAndReportState extends State<StudentHelpAndReport> {
  @override
                            ...
                            child: Stack(
                              children: [
                                Positioned(
                                    top: 0,
                                    child:
                                        StudentHeader(name: "Help and Report")),
                                Positioned(
                                  top: 130,
                                  left: 50,
                                  child: Container(
