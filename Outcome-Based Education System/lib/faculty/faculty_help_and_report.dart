...
class FacultyHelpAndReport extends StatefulWidget {
  const FacultyHelpAndReport({super.key});

  @override
  State<FacultyHelpAndReport> createState() => _FacultyHelpAndReportState();
}

class _FacultyHelpAndReportState extends State<FacultyHelpAndReport> {
  @override
                            ...
                            child: Stack(
                              children: [
                                Positioned(
                                    top: 0,
                                    child:
                                        FacultyHeader(name: "Help and Report")),
                                Positioned(
                                  top: 130,
                                  left: 50,
                                  child: Container(
