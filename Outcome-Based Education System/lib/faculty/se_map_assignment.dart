...
class _SEMapObeAssignmentState extends State<SEMapObeAssignment> {
  ...
  Future<void> addAssignment() async {
    ...
    final assignmentData = {
      ...
      // 'questionFileURL': questionTextController.text, // Store the file URL
  ...
  Future<void> uploadAssignmentQuestion(String assignmentId, String questionTitle, BuildContext context) async {
    try {
      // Pick file
                        ...
                        child: Container(
                          ...
                          child: const Stack(
                            children: [
                              Positioned(
                                  top: 0,
                                  child: FacultyHeader(name: "SE Assignment")),
                            ],
                          ),
                        ),
                      ),
                    ...
                    child: DataTable(
                      ...
                      rows: assignmentList.map((assignment) {
                        return DataRow(cells: [
                          ...
                          DataCell(Center(
                              child: Text(assignment['assignment'] ?? ''))),
